...
class ModalImportarCsv extends Component{
    constructor(props){
        super(props);
    ...
    handleSubmit(e){
        ...
        data.append("listaSucursales", JSON.stringify(this.props.listaSucursales));
    ...
    handleVerificarSucursales(e){
        ...
        let listaSucursales = [];
        for (let i = 1; i < this.props.listaSucursales.length; i++){
            listaSucursales.push(this.props.listaSucursales[i].nombreSucursal);
        }
        // *****************************************
        let existe = true;
        ...
        return (
            <div>
                ...
                <div className="modal fade"
                     ...
                     tabIndex="-1"
                     role="dialog"
                     aria-labelledby="modalImportarCsv"
                     aria-hidden="true"
                >
